...
1. **Project Source Code**
   ...
   - Supporting documentation under `submission/` and `docs/`

2. **Project Profile Document (PDF)**
   - Generated file: `submission/track1-project-profile.pdf`
   - Source markdown: `submission/PROJECT_PROFILE.md`

3. **Demo Video**
   - Demo artifact: `data/demo/demo.mp4`

4. **Supplementary Material**
   - Poster artifact: `submission/track1-poster.svg`
